...
<!-- jQuery Vector Maps -->
<script src="{{ asset('backassets/js/plugin/jqvmap/jquery.vmap.min.js') }}"></script>
<script src="{{ asset('backassets/js/plugin/jqvmap/maps/jquery.vmap.world.js') }}"></script>

<!-- Sweet Alert -->
<script src="{{ asset('backassets/js/plugin/sweetalert/sweetalert.min.js') }}"></script>

<!-- Atlantis JS -->
<script src="{{ asset('backassets/js/atlantis.min.js') }}"></script>

<!-- Atlantis DEMO methods, don't include it in your project! -->
<script src="{{ asset('backassets/js/setting-demo.js') }}"></script>
<script src="{{ asset('backassets/js/demo.js') }}"></script>
<script>
    Circles.create({
        id:'circles-1',
        radius:45,
